...
#     
#     # Get index for this model
#     idx_reduced <- Ginflu::get_index (fit_reduced,  pred_grid = pred_grid, predictor = predictor)
#     # print(summary(fit_reduced))
#     # Generate the right hand side of formula as name for index
#     idx_name <- case_when(
#       termCount == 1                           ~ term,
...
#                   NA)
#   
#   summary_fit[[termCount+1]] <- data.frame(term = term,
#                                            df = extractAIC(fit_reduced)[1],
#                                            AIC = aic,
#                                            r2Dev = r2Dev
#   ) 
...
# 
# # combine summary stats:
# summary_fit <- do.call(rbind, summary_fit)  %>%
#   mutate(
#     r2Dev_delta = r2Dev - lag(r2Dev),
#     df = df - lag(df),
#     Included = "*"
#   )
# 
